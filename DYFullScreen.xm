...
- (NSArray *)dy_buildGlobalSearchEntries {
    ...
    // 主面板
    add(@"基本设置", @"__DYTOOLS_BASIC_CATEGORY__", @"设置", @"basicCategory", @"基本设置 通用 基础");
    ...
    add(@"视频全屏", kDYFSFullScreenEnabledKey, @"全屏", @"main", @"全屏 视频 全屏播放");
    ...
    NSArray *basic = @[
        ...
        @[@"屏蔽灵动岛播放信息",@"DYYYDisableFeedNowPlayingInfo",@"灵动岛 播放信息"]
    ];
    for (NSArray *x in basic) add(x[0],x[1],@"基本设置",@"basic",x[2]);

    // 视频设置
    add(@"视频设置",@"__DYTOOLS_VIDEO_SETTINGS__",@"视频界面",@"videoCategory",@"视频设置");
    add(@"移除顶栏",@"__DYTOOLS_TOPBAR__",@"视频界面",@"topCategory",@"顶栏 上栏 顶部");
    add(@"移除底栏",@"__DYTOOLS_BOTTOMBAR__",@"视频界面",@"bottomCategory",@"底栏 底部 导航栏");
    add(@"移除去汽水听",kDYToolsRemoveShuiTingKey,@"视频设置",@"video",@"汽水听 去汽水听");
    add(@"移除相关搜索",kDYToolsRemoveRelatedSearchKey,@"视频设置",@"video",@"相关搜索 搜索");
    add(@"移除热点栏",kDYToolsRemoveHotspotKey,@"视频设置",@"video",@"热点 热点栏");
    add(@"移除音乐按钮",kDYToolsHideMusicButtonKey,@"视频设置",@"video",@"音乐 音乐按钮");
    add(@"移除视频位置",kDYToolsHideLocationKey,@"视频设置",@"video",@"位置 视频位置 属地");
    ...
    NSArray *bottom = @[
        ...
        @[@"隐藏底栏红点",@"DYYYHideBottomDot",@"底栏 红点 小红点 红色圆点 消息红点"],
...
@interface DYToolsControlViewController : UIViewController <UISearchResultsUpdating, UISearchBarDelegate, UISearchControllerDelegate>
@end
